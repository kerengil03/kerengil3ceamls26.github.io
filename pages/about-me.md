...
about:
  name: Keren Gil
  role: Sophmore, Hospitality Management
  ...
  hobbies:
    - icon: 🏃🏻‍♀️
      title: Running
      description: I love running, and I have ran track for a while now and started from when I was 12 & have kept going ever since 
    - icon: ➿
      title: Styling Hair
      description: I love to style my own hair all the time I'll always be trying something different or new
    - icon: 📚
      title: Reading
      description: I've loved to read books since I was younger, especially in sci-fi, drama, & adult genres

  gallery:
    - image: assets/images/about me.png
      caption: I get into a little bit of everything, from doing hair, to volunteering at church & runnning.
